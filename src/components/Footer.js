            ...
            <Col md={5}>
              ...
              <Col md={6} className="footernav">
                ...
                <nav style={{
                  ...
                  {meta.menu.map((item, i)=> {
                    if (item.to === "DROPDOWN") {
                      ...
                      return(
                        <Link className="navbar-item" to={"/"+item.to} key={"footermainnav-name-"+i+"-"+item.name} style={{
                          color: "white"
                        }}>{item.name}</Link>
                      )
                    }
                ...
                <nav style={{
                  ...
                  {meta.footermenu.map((item, i)=> <Link className="navbar-item" to={"/"+item.to} key={"footernav-link-"+i+"-"+item.name} style={{
                    color: "white"
                  }}>{item.name}</Link>)}
                </nav>
              </Col>
